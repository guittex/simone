...
class UsersController extends AppController
{
    ...
    public function login()
    {
        ...
        if ($result->isValid()) {
            ...
            $redirect = $this->request->getQuery('redirect', DS);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->Flash->error(__('Não foi possível adicionar este usuário'));
        }
        $this->set(compact('user'));
    }
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $this->Flash->error(__('Não foi possível editar este usuário'));
        }
        $this->set(compact('user'));
    }
