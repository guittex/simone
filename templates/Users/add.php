      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <?php echo $this->Form->create($user, ['role' => 'form']); ?>
            <div class="box-body">
              <div class="col-md-6">
                <?= $this->Form->control('nome_completo',['placeholder' => 'Digite...']); ?>
              </div>
              <div class="col-md-3">
                <?= $this->Form->control('email',['placeholder' => 'Digite...']); ?>
              </div>
              <div class="col-md-3">
                <?= $this->Form->control('password',['placeholder' => 'Digite...', 'label' => 'Senha' ,'type' => 'password']); ?>
              </div>             
            </div>
            <!-- /.box-body -->

            <div class="box-footer">
              <button class="btn btn-success btn-flat float-r">Adicionar</button>
            </div>
